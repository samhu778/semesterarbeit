function [BodyParameter, IMUParameter, FrameParameter] = get_SystemParameter(theta)
    ...
    BodyParameter(1) = BodyParameter(1).set_Joint_Parameter([0; 0; 0], [0; 0; 0]);
    BodyParameter(1)= BodyParameter(1).set_Joint_Parameter([0.2; 0; 0], [0; 0; 0]);

    BodyParameter(2) = BodyParameterClass(1, 2, 'y', '2');
    BodyParameter(2)= BodyParameter(2).set_Joint_Parameter([0; 0; 0], [0; 0; 0]);
    BodyParameter(2)=BodyParameter(2).set_Joint_Parameter([0.2; 0; 0], [0; 0; 0]);
    ...
    FrameParameter=FrameParameter.set_Joint_Parameter([0;0;0], [0;0;0]);
